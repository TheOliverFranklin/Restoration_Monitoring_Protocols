...
data_dir <- "C:/Users/ZARGARPOURN/Documents/SAR Team/Monitoring Protocols/R Code/LWDJam"
```
...
if (interactive()) {
  ...
  output_folder <- "C:/Users/ZARGARPOURN/Documents/SAR Team/Monitoring Protocols/R Code/LWDJam/Output"
  if (!dir.exists(output_folder)) {
    dir.create(output_folder, recursive = TRUE)
...
summary_table_jam <- logjam_data %>%
  ...
  summarise(
    ...
    Frequency_Jams_per_100m = n() / first(Reach_Length) * 100,
...
logjam_table<-tags$div(
  ...
  reactable(summary_table_jam,searchable=TRUE, bordered=TRUE, highlight=TRUE,columns = list(
    ...
    Frequency_Jams_per_100m = colDef(name = "Frequency of Logjams per 100 m", 
