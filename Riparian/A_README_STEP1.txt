...
This folder contains the Line Intercept Riparian Survey package. The files, in the order that you will need them, are as follows:

- txt: this readme :)

- pdf file: The pdf contains step-by-step field guidance to collect data, along with some background and rationale. It includes a one-page field reference sheet and the field datasheet. 
