...
if (consistent_direction) {
  global_direction <- "downstream"   # ----------  Step 2: specify "upstream" or "downstream"  (include quotation marks). Then there are no more user inputs for you in this section.
  
  survey_direction <- df %>%
    distinct(Site, year) %>%
    mutate(Transect1Location = global_direction)
